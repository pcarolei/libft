...
/*   Updated: 2020/04/10 09:01:01 by pcarolei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <libft.h>

static int	get_dot_pos(char *str)
{
	int i;
...
static char	*float_round_prec_0(char *str)
{
	int		i;
	int		carry;
	int		sum;
...
static char	*float_round(char *str, int precision)
{
	char	*res;
	int		i;
	int		carry;
